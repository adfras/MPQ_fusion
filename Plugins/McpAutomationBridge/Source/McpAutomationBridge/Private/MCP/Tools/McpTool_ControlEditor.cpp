...
public:
	...
	{
		return TEXT("Start/stop PIE or VR Preview, control viewport camera, run console commands, "
	...
	TSharedPtr<FJsonObject> BuildInputSchema() const override
	{
		return FMcpSchemaBuilder()
			...
			.Bool(TEXT("vrPreview"), TEXT("Start play using the editor VR Preview path."))
			.String(TEXT("previewType"), TEXT("Optional play preview type, e.g. vrPreview."))

...
struct FMediaPipeBodySolverState
{
	...
	bool bHasStage2ShoulderLiftBaselineL = false;
	float Stage2ShoulderLiftBaselineCmL = 0.0f;
	bool bHasSmoothedStage2ClavicleLiftR = false;
	float SmoothedStage2ClavicleLiftCmR = 0.0f;
	bool bHasStage2ShoulderLiftBaselineR = false;
	float Stage2ShoulderLiftBaselineCmR = 0.0f;
	...
	void ResetTracking()
	{
		...
		bHasStage2ShoulderLiftBaselineL = false;
		Stage2ShoulderLiftBaselineCmL = 0.0f;
		bHasSmoothedStage2ClavicleLiftR = false;
		SmoothedStage2ClavicleLiftCmR = 0.0f;
		bHasStage2ShoulderLiftBaselineR = false;
		Stage2ShoulderLiftBaselineCmR = 0.0f;

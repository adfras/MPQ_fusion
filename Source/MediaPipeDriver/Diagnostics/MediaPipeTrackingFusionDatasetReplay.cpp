...
void FMediaPipeTrackingFusionDatasetReplayRuntime::ApplyReplayPoseCVars_GameThread()
{
	...
	SetConsoleInt(TEXT("mp.BodyFusion.WritePose"), 1);
	SetConsoleInt(TEXT("mp.BodyFusion.Debug"), 1);
	SetConsoleInt(TEXT("mp.BodyFusion.MediaPipeAuthority"), 2);
	SetConsoleInt(TEXT("mp.BodyFusion.FullBodyMediaPipeAuthority"), 1);
	SetConsoleInt(TEXT("mp.BodyFusion.CalibrationStableFrames"), 1);
	SetConsoleFloat(TEXT("mp.BodyFusion.CalibrationHoldSeconds"), 0.0f);
	SetConsoleInt(TEXT("mp.MediaPipeDriveSpine"), 1);
	SetConsoleInt(TEXT("mp.MediaPipeDrivePelvisTranslation"), 1);
	SetConsoleInt(TEXT("mp.MediaPipeDriveLegs"), 1);
